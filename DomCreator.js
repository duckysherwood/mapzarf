    ...
    if(layerTypeName in this.mai) { 
        ...
        if (layerSpecs != undefined) {
            ...
            if( layersCount == 1) {
                ...
                var longerDescription = 'Show '+layerSpecs[key].shortDescription
                layerDescriptionSpan.textContent = longerDescription
                layerSelectionControl.appendChild(layerDescriptionSpan)

            } else {
                
                layerSelectionCheckbox.value = '' // don't-care
                layerDescriptionSpan.textContent = 'Show ' + layerTypeName + ": "
                layerSelectionControl.appendChild(layerDescriptionSpan)
